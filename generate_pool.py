    ...
    try:
        ...
        if contest_id:
            ...
            if crow:
                ...
                # Contest pool: large enough for representative sampling (fieldMult handles the rest)
                # User pool: large enough to have real selection diversity
                c_size = min(max_entries, 2000)
                u_size = min(max_entries, 3000)
